...
const generateInvoicePDFBuffer = (order, shop, shipping_charge = 0) => {
  return new Promise((resolve, reject) => {
    ...
    doc.fillColor('#1e293b').font('Helvetica-Bold').text(`$${order.total_amount.toFixed(2)}`, 450, position, { width: 112, align: 'right' });
    position += 15;
    ...
    doc.fillColor('#cbd5e1').text(`Generated by W DISTRO on ${genTime}`, 50, footerTop + 22, { align: 'center', width: 512 });
