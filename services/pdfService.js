...
const generateInvoicePDFBuffer = (order, shop, shipping_charge = 0) => {
  return new Promise((resolve, reject) => {
    ...
    doc.text('support@wdistro.com | +1 530-490-8786', 50, 128);
    ...
    doc.fillColor('#cbd5e1').text(`Generated by W DISTRO on ${genTime} (California Time)`, 50, footerTop + 22, { align: 'center', width: 512 });
